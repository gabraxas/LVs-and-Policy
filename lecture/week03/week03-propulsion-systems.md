...
![추력 방정식 — 운동량항과 압력항](images/01-thrust-equation.png)
...
![노즐 팽창 상태 — 과팽창·최적팽창·부족팽창](images/02-nozzle-expansion-regimes.png)
...
![추진제별 연소온도·분자량·비추력 비교](images/03-propellant-isp-comparison.png)
...
![c*와 C_F — 연소기와 노즐의 성적표](images/04-cstar-cf-breakdown.png)
...
![그레인 단면 형상과 추력 프로파일](images/05-solid-grain-thrust-profiles.png)
...
![추진제 밀도-비추력 트레이드오프](images/06-density-isp-tradeoff.png)
...
![엔진 사이클 5종 개략도](images/07-engine-cycles-overview.png)
...
![엔진 사이클 종합 비교 — 성능 vs 개발 난이도](images/08-cycle-performance-vs-risk.png)
...
![엔진 개발 일정 — 임계경로](images/09-engine-development-timeline.png)
...
![세계 주력 엔진 비교 — 추력 vs 비추력](images/10-world-engines-map.png)
